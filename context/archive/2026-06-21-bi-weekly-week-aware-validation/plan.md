...
- [x] 2.7 Collision dialog explains a same-week clash legibly — 6b36a18
...
- [x] 3.6 Palette suggests EE+CAS opposite-week grouping with A/B badge — 6b36a18
...
- [x] 4.3 Create/edit "Bi-weekly" persists `week_mode = biweekly` — 6b36a18
- [x] 4.4 Course table shows Bi-weekly badge on EE/CAS — 6b36a18
- [x] 4.5 Switching back to Agnostic clears the badge and persists — 6b36a18

### Phase 5: Board Week UI

#### Automated

- [x] 5.1 `drop-hints` unit tests pass (incl. soft-aware case) — 6b36a18
- [x] 5.2 Type/lint/build/steiger clean — 6b36a18
- [x] 5.3 Full local gate passes (`/verify`) — 6b36a18

#### Manual

- [x] 5.4 Slot with A and B placements renders stacked lanes; ghost on empty lane; agnostic spans both — 6b36a18
- [x] 5.5 Per-chip A/B control appears only on bi-weekly chips and moves the chip (persisted) — 6b36a18
- [x] 5.6 Dragging EE+CAS opposite-week grouping auto-assigns opposite weeks, no ring — 6b36a18
- [x] 5.7 Single bi-weekly drag over soft-conflicting cell shows opposite-week affordance, not blocked — 6b36a18
- [x] 5.8 Agnostic-only cells unchanged — 6b36a18
- [x] 5.9 Existing e2e suite passes (`pnpm test:e2e`) — 6b36a18
