...
- [x] 4.1 src/components/, src/layouts/, src/lib/, src/styles/ deleted — 1751741
- [x] 4.2 No __tests__/ subdirectories remain — 1751741
- [x] 4.3 Steiger clean: `pnpm dlx steiger src` (zero errors) — 1751741
- [x] 4.4 Full CI gate passes: install → astro sync → lint → test → build — 1751741

#### Manual

- [x] 4.5 Full app smoke test: every page, every CRUD operation, planner drag-drop — 1751741

### Phase 5: Behavioral Changes

#### Automated

- [x] 5.1 lessons.md updated with unified Actions rule — a5b95ba
- [x] 5.2 Placement Actions created and wired — a5b95ba
- [x] 5.3 Grouping Action created and wired — a5b95ba
- [x] 5.4 Actions barrel updated with new action groups — a5b95ba
- [x] 5.5 Obsolete files deleted (API routes, client.ts) — a5b95ba
- [x] 5.6 Auth DS compliance fixed (zero palette colors in auth components) — a5b95ba
- [x] 5.7 Build passes: `pnpm build` — a5b95ba
- [x] 5.8 Tests pass: `pnpm test` — a5b95ba
- [x] 5.9 Lint passes: `pnpm lint` — a5b95ba
- [x] 5.10 Steiger clean: `pnpm dlx steiger src` — a5b95ba

#### Manual

- [x] 5.11 Planner placement works end-to-end (add, move, remove) — a5b95ba
- [x] 5.12 Grouping computation works from empty state — a5b95ba
- [x] 5.13 Sign-in form renders correctly in light and dark themes — a5b95ba
- [x] 5.14 Sign-out flow works — a5b95ba
