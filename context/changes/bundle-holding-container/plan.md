...
- [ ] 4.1 Type checking passes: `pnpm check`
- [ ] 4.2 Linting + FSD structure pass: `pnpm lint` && `pnpm steiger`
- [ ] 4.3 Build is clean: `pnpm build`
- [ ] 4.4 Unit suite green: `pnpm test`
- [ ] 4.5 Durability E2E passes: `pnpm test:e2e`

#### Manual

- [ ] 4.6 Lift via button and via drag-to-edge both park; badge increments
- [ ] 4.7 Drawer expands and reflows the grid once (no mid-drag shift); all cells reachable
- [ ] 4.8 Drag-back onto empty places; onto occupied merges with accept-and-flag
- [ ] 4.9 Reload preserves parked bundles; cohort switch shows only that cohort's set
- [ ] 4.10 Pinned drawer persists across actions; Safari private mode degrades silently
- [ ] 4.11 Parked card uses neutral tokens; light/dark both correct
