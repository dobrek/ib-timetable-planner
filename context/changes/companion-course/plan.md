...
- [x] 2.1 Type checking passes: `pnpm check` — 1247f3f
- [x] 2.2 Unit + RTL tests pass: `pnpm test` — 1247f3f
- [x] 2.3 Linting passes: `pnpm lint` — 1247f3f
- [x] 2.4 FSD structure check passes: `pnpm steiger` — 1247f3f
- [x] 2.5 Production build stays clean: `pnpm build` — 1247f3f

#### Manual

- [x] 2.6 Leading select enables the companion; options are co-occurring only, alphabetical, leading absent — 1247f3f
- [x] 2.7 Selecting a companion narrows the list to both-course groupings — 1247f3f
- [x] 2.8 Changing/clearing the leading course resets (and disables) the companion — 1247f3f
- [x] 2.9 Cohort switch + reload returns both selects to cleared state — 1247f3f
- [x] 2.10 No regression to the leading filter, its sort toggle, or palette drag-and-drop — 1247f3f
