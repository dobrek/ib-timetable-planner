...
- [ ] 2.1 Unit tests pass incl. `countStudentHoles` parity pin and mirrored-cell fixture-detector case: `pnpm test`
- [ ] 2.2 `pnpm check` && `pnpm lint` && `pnpm steiger` && `pnpm build` stay green
