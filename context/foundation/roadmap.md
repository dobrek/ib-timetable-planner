...
| S-306 | drift-decided-delivery          | the proposal is a plan — pending while it solves, an ordinary plan once delivered; the source is never written to | S-301                      | FR-306, FR-307, FR-308, FR-309, FR-313, US-301, US-303                | proposed |
