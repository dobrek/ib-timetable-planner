 ...
 * but a stale or crafted call could attach cross-cohort, cross-plan, or non-existent choices
 * that S-06's grouping would choke on. Every submitted course id must exist AND belong to the
 * plan + cohort (composite FKs backstop the plan pin). No-op for the empty set.
 */
