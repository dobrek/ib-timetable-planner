...
/** Compact choice label: course name + level (unless "none") + circled group-index suffix when > 0. */
export function formatChoiceLabel(course: { name: string; level: string; groupIndex: number }): string {
