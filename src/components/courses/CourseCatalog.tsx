...
const GROUP_LABELS: Record<number, string> = { 0: "—", 1: "Group 1", 2: "Group 2" };

/**
 * Catalog island: cross-cohort course list as Year 1 / Year 2 tabs with a teacher
 * multi-select filter. Read-only this phase — the "New course" button and per-row
 * kebab are wired to dialogs in Phases 3–4. Composite merge parents carry a "Merged"
 * badge beside the name but remain fully editable (merge-specific constraints are
 * deferred to the merge-builder slice). Tokens only (lessons rule #2).
 */
...
/** Per-row kebab — present on every course (merged or not). Item handlers wired in Phases 3–4. */
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem>Manage overlaps</DropdownMenuItem>
